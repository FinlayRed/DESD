...
from .views import (
    ...
    ProducerSettlementCsvExportView,
...
urlpatterns = [
    ...
    path("customer/products/<int:pk>/", ProductDetailView.as_view(), name="customer-product-detail"),
    path("customer/products/<int:product_id>/review/", ReviewCreateView.as_view(), name="review-create"),
    ...
    path("producer/settlements/<int:pk>/export/", ProducerSettlementCsvExportView.as_view(), name="settlement-export"),
